      ...
      <div class="col">
        <form @submit.prevent="search">
          <div class="mb-3 form-row-container">
            ...
            <Multiselect v-model="selectedIds"
                         :options="uniqueIds"
                         :multiple="true"
      ...
      try {
        ...
        d3.selectAll("circle")
          .style("visibility", d => {
            ...
            return ((this.nodeFilters[d.type] || this.nodeFilters["unspecified"] || !d.type) && (isVisibleOutgoingNode || isVisibleIncomingNode)) ? "visible" : "hidden";
          });
      } catch (error) {
